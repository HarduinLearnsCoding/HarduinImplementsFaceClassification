function[facesMDA,datavisualise,mean0,scatterbetween,scatterwithin,priors,eigenvalues,eigenvectors,eigenvaluesdiag,eigenvectorstr]=poseMDAsolver(facestemp,mean,covar,numclasses,dimensions)
...
for i=1:68
    for j=1:13
        newfacestemp(:,:,j,i)=reshape(facestemp(:,:,j,i),[1,1920]);
    end
end
...
[eigenvectors,eigenvalues]=eig(matrixcreated,'vector');
...
facesMDA=pagemtimes(newfacestemp,eigenvectorstr);
